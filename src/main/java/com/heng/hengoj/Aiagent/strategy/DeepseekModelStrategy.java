package com.heng.hengoj.Aiagent.strategy;


import com.heng.hengoj.model.dto.Aiagent.ContentDto;
import com.heng.hengoj.model.dto.Aiagent.OllamaResult;
import com.heng.hengoj.utils.JsonUtils;
import okhttp3.*;
...
public class DeepseekModelStrategy implements AiModelStrategy {
    ...
    private static final String URL_OLLAMA = "http://192.168.0.107:11434/api/generate";
